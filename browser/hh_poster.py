...
class MyChromeWebdriver:
    ...
    def get_vacancy_list_from_cv(self, cv_title):
        ...
        try:
            link = ""
            driver.get("https://hh.ru/applicant/resumes?hhtmFrom=short_resume&hhtmFromLabel=header")
...
if __name__ == "__main__":
    ...
    try:
        ...
        cv_name = "Тестировщик"
        href = my_driver.get_vacancy_list_from_cv(cv_name)
